...
public class SplayTest {
	...
	private SplayTreeImpl<Integer> splay;
	...
	public void testInsert() {
		...
		assertArrayEquals(new Integer[] { 5 }, splay.toArrayPreOrder());
		...
		assertEquals(1, splay.height());
		assertArrayEquals(new Integer[] { -15, 5 }, splay.toArrayPreOrder());

		splay.insert(99);
		assertEquals(3, splay.size());
		assertEquals(2, splay.height());
		Comparable<Integer>[] toArrayPreOrder = splay.toArrayPreOrder();
		assertArrayEquals(new Integer[] { 99, 5, -15 }, toArrayPreOrder);
	}
	...
	public void testRemove() {
		...
		splay.remove(1);
		assertEquals(3, splay.size());
		assertArrayEquals(new Integer[] { -100, 5, 120 }, splay.toArrayPreOrder());
		splay.search(3);
		assertArrayEquals(new Integer[] { 5, -100, 120 }, splay.toArrayPreOrder());

		splay.remove(-100);
		assertEquals(2, splay.size());
		assertArrayEquals(new Integer[] { 5, 120 }, splay.toArrayPreOrder());
		splay.search(120);
		assertArrayEquals(new Integer[] { 120, 5 }, splay.toArrayPreOrder());
...
//		assertEquaIs(splay.size(), 4);
	...
	public void meusTests() {
		...
		assertArrayEquals(new Integer[] { 1, 5, 13, 22 }, splay.toArrayPreOrder());
		...
		assertEquals(3, splay.height());
		assertArrayEquals(new Integer[] { 3, 0, 1, 5, 13, 22 }, splay.toArrayPreOrder());
		...
		assertArrayEquals(new Integer[] { 100, 22, 18, 5, 3, 0, 1, 13 }, splay.toArrayPreOrder());

		splay.search(5);

		assertEquals(8, splay.size());
		assertEquals(3, splay.height());
		assertArrayEquals(new Integer[] { 5, 3, 0, 1, 100, 18, 13, 22 }, splay.toArrayPreOrder());

		splay.search(9);

		assertEquals(8, splay.size());
		assertEquals(4, splay.height());
		assertArrayEquals(new Integer[] { 13, 5, 3, 0, 1, 18, 100, 22 }, splay.toArrayPreOrder());

		splay.search(3);

		assertEquals(8, splay.size());
		assertEquals(5, splay.height());
		assertArrayEquals(new Integer[] { 3, 0, 1, 5, 13, 18, 100, 22 }, splay.toArrayPreOrder());
	}
	...
	public void meusTestRemove() {
		...
		assertEquals(3, splay.height());
		assertArrayEquals(new Integer[] { 10, 9, 1, 5, 35, 13, 22 }, splay.toArrayPreOrder());

		splay.remove(12);

		assertEquals(7, splay.size());
		assertEquals(4, splay.height());
		assertArrayEquals(new Integer[] { 13, 10, 9, 1, 5, 35, 22 }, splay.toArrayPreOrder());

		splay.remove(5);

		assertEquals(6, splay.size());
		assertEquals(3, splay.height());
		assertArrayEquals(new Integer[] { 1, 13, 9, 10, 35, 22 }, splay.toArrayPreOrder());

		splay.remove(1);

		assertEquals(5, splay.size());
		assertEquals(2, splay.height());
		assertArrayEquals(new Integer[] { 13, 9, 10, 35, 22 }, splay.toArrayPreOrder());

		splay.remove(13);

		assertEquals(4, splay.size());
		assertEquals(2, splay.height());
		assertArrayEquals(new Integer[] { 22, 9, 10, 35 }, splay.toArrayPreOrder());

		splay.remove(22);

		assertEquals(3, splay.size());
		assertEquals(2, splay.height());
		assertArrayEquals(new Integer[] { 35, 9, 10 }, splay.toArrayPreOrder());
		
		splay.remove(9);

		assertEquals(2, splay.size());
		assertEquals(1, splay.height());
		assertArrayEquals(new Integer[] { 35, 10 }, splay.toArrayPreOrder());

		splay.remove(9);

		assertEquals(2, splay.size());
		assertEquals(1, splay.height());
		assertArrayEquals(new Integer[] { 10, 35 }, splay.toArrayPreOrder());

		splay.remove(10);

		assertEquals(1, splay.size());
		assertEquals(0, splay.height());
		assertArrayEquals(new Integer[] { 35 }, splay.toArrayPreOrder());

		splay.remove(35);

		assertEquals(0, splay.size());
		assertEquals(-1, splay.height());
		assertArrayEquals(new Integer[] {}, splay.toArrayPreOrder());

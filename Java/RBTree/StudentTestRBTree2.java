...
public class StudentTestRBTree2 {
	...
	public void naoOqueVoceEsperavaPontoPy() {
		...
		assertTrue(myRB.search(1).isNIL());
		...
		myRB.insert(25);
		myRB.insert(30);
		assertFalse(myRB.search(25).isNIL());
		assertFalse(myRB.search(30).isNIL());
		assertFalse(myRB.search(10).isNIL());
		...
		assertFalse(myRB.search(35).isNIL());
		assertEquals(myRB.blackHeight(), 2);
		assertTrue(myRB.verifyProperties());
		Assert.assertArrayEquals(myRB.rbPreOrder(), awyiss((RBNode<Integer>) myRB.getRoot()));
		...
		assertFalse(myRB.search(50).isNIL());
		assertFalse(myRB.search(65).isNIL());
		...
		assertFalse(myRB.search(-4).isNIL());
		assertFalse(myRB.search(-19).isNIL());
		assertEquals(myRB.blackHeight(), 3);
		Assert.assertArrayEquals(myRB.rbPreOrder(), awyiss((RBNode<Integer>) myRB.getRoot()));
		...
		assertFalse(myRB.search(-34).isNIL());
		assertFalse(myRB.search(-29).isNIL());
		assertEquals(myRB.blackHeight(), 3);
		Assert.assertArrayEquals(myRB.rbPreOrder(), awyiss((RBNode<Integer>) myRB.getRoot()));
	...
	private RBNode<? extends Comparable<?>> e(Node<?> ue) {

...
public class StudentSkipListTest {
	...
	public void testInsert() {
		...
		array = skip.toArray();
		assertEquals("[<ROOT,7,7>, <0,1>, <5,3>, <10,2>, <12,7>, <15,3>, <20,1>, <NIL,7>]", Arrays.toString(array));
		...
		assertEquals(12, array[2].getForward(2).getKey());
		assertEquals(12, array[3].getForward(0).getKey());
		assertEquals(12, array[3].getForward(1).getKey());
		assertEquals(15, array[4].getForward(0).getKey());
		assertEquals(Integer.MAX_VALUE, array[4].getForward(6).getKey());
		assertEquals(Integer.MAX_VALUE, array[4].getForward(5).getKey());
		assertEquals(Integer.MAX_VALUE, array[6].getForward(0).getKey());

		List<String> aux = new ArrayList<>();
		for (int i = 1; i < array.length - 1; ++i)
			aux.add(array[i].getValue());

		assertEquals("[C, E, A, Z, D, B]", aux.toString());
		...
		assertEquals("[A, B, C, Z, D, E]", aux.toString());
	}
